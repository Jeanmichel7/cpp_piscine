...
/*   Updated: 2022/08/01 23:10:10 by jrasser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << GRY "Dervied class	CONSTRUCTOR called - " END << name << std::endl;
	return; 
}

ScavTrap::ScavTrap( const ScavTrap &tmp ) : ClapTrap( tmp )
{
	std::cout << GRY "Dervied class	COPY CONSTRUCTOR called" END << std::endl;
	return; 
}
...
ScavTrap::~ScavTrap()
{
	std::cout << GRY "Derived class	destructor called" END << std::endl;
	return ;
}
